<script lang="ts">
    ...
    const totalCatExp = $derived(
        data?.expensesByCategory.reduce((s, c) => s + c.total, 0) ?? 0
    );
                ...
                <div class="card bg-base-200 shadow-xl">
                    <div class="card-body gap-4">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            {#if tasks}
                                <div class="flex items-center gap-3">
                                    <div class="radial-progress text-secondary shrink-0"
                                         style="--value:{taskRate(tasks.done, tasks.open)}; --size:3.5rem; --thickness:5px;"
