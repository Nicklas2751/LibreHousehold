...
microsite.with {
    ...
    title = 'LibreHousehold - Architecture Documentation'
    ...
    //
    // Github Repository
    footerGithub = 'https://github.com/Nicklas2751/LibreHousehold'
    //
    // Slack Channel
    ...
    issueUrl = 'https://github.com/Nicklas2751/LibreHousehold/issues/new'
    //
    ...
    gitRepoUrl = 'https://github.com/Nicklas2751/LibreHousehold/edit/main/docs/architecture/'
    ...
    menu = [overview:"Overview", arc42:"Documentation",adrs:"-",personas:"-",chapters:"-"]
...
//end::additionalConverters[]
    ...
    //                 default `/microsite/tmp/site/docs`
...
//    asciidoctorAttributes = ["imagesDir=../images" ]
}
...
openApi.with {
    specFile = 'src/docs/petstore-v2.0.yaml' // i.e. 'petstore.yaml', 'src/docs/petstore.yaml'
