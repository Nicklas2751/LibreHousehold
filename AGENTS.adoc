...
*   **Frontend Logic**:
    ...
    *   `Expense List`: Status badges temporarily removed as the monolithic endpoint was replaced. Re-implementation planned with `/details` integration.
*   **Backend Note**: Backend directory was found empty. API Spec is ready for implementation by backend team.
