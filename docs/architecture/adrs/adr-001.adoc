...
To keep it simple, easy to understand and maintainable (<<QG4,QG4>>) the application will be implemented as a split application with a frontend and a backend communicating via an API.
