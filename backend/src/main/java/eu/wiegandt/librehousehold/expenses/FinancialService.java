...
class FinancialService {
    ...
    FinancialService(ExpenseRepository expenseRepository,
    ...
    FinancialSummary getFinancialSummary(UUID householdId, UUID userId) {
    ...
    List<MemberBalance> getMemberBalances(UUID householdId, UUID userId) {
